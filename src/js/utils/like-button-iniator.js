...
const LikeButtonIniator = {
    ...
    async _checkMovieStat() {
        ...
        movieLiked ? 
        renderLikedButton() : renderNotLikedButton() ;
    ...
    async _likedStat() {
        ...
        await console.log( 'sedang menghapus like status', (await FavoriteMovieIdb.deleteMovie(this._detailMovie.id))) ; 
        
    },

    async _notLikedStat() {
        this._likeButtonContainer.innerHTML = renderLikedButton() ; 
        await console.log( 'sedang menambahkan like status', (await FavoriteMovieIdb.putMovie(this._detailMovie))) ; 
    },
